...
const Guide = () => {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black p-6 flex justify-center items-center">
        <div className="w-full max-w-3xl bg-gray-950 p-10 rounded-md border-4 border-yellow-500 shadow-xl shadow-yellow-500/50">
          {/* Luxurious Header */}
          ...
          <section
            ...
            className="bg-gray-900 p-8 rounded-2xl border border-yellow-500 shadow-lg shadow-yellow-500/30"
          >
            <h2
                ...
                <li key={index} className="flex items-start">
                  ...
                  <span>
                    ...
                    {item.strongText && item.strongText.map((text, idx) => (
                      <strong key={idx} className="text-yellow-400"> {text} </strong>
                    ))}
                  </span>
                </li>
              ))}

...
const FinanceAct = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#D72638] pt-4 pb-4 pl-2">
        <div className="flex justify-center w-full max-w-screen-5xl">
          <div className="bg-white md:mb-2 mt-6 md:w-3/4 w-full md:h-screen md:mt-2 md:ml-2 p-6 rounded-md shadow-md overflow-y-auto mr-2 mb-16">
            <div className="flex flex-col justify-center flex-1">
              <header>
                <h1 className="text-2xl font-semibold text-center text-[#D72638] mb-2">
                  Finance Act 2023
                </h1>
              </header>
              ...
              <div className="flex items-center max-h-[75vh] mb-4">
                ...
                {/* <button
                  ...
                  className="bg-[#D72638] text-sm hover:bg-[#FFD700] hover:text-[#D72638] text-[#FFD700] font-bold py-1 px-4 rounded-md mr-2"
                >
                  Export Excel
                </button>
                <button
                  onClick={exportToCSV}
                  className="bg-[#D72638] text-sm hover:bg-[#FFD700] hover:text-[#D72638] text-[#FFD700] font-bold py-1 px-4 rounded-md"
                >
                  Export CSV
                </button> */}
              </div>
              ...
              <div className="overflow-x-auto">
                <div className="table-container  min-h-[75vh]">
                  ...
                  <table className="w-full border-collapse border border-[#FFD700]">
                    <thead className="sticky top-0 bg-[#D72638]">
                      <tr>
                        <th
                    ...
                    <tbody>
                      {filteredData.map((item) => (
                        <tr
                          key={item._id}
                          className="text-[#D72638] text-sm font-semibold border border-[#FFD700]"
                        >
